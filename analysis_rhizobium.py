...
# I have decided to created a python file containing all the analysis that are going to be included in the paper. In order to have a better control of the modifications I make.
''' 
1. Genospecies boundaries: distribution plots and presence absence plots (venn_genospecies and figure_3.py)
2. Concatenated core genes, based on conservative core genes found by Harrissons 2010
3. Average Nucleotide Identity
4. PCA on gene level
5. PCA on allelic level
6. Intergenic LD
7. Mk Donald Kreitman test 
8. SFS
9. GC %
10. 
...
def creating_presence_absence_matrix(filename = 'C:/Users/MariaIzabel/Desktop/MASTER/PHD/Syn-Non/gene_groups/gene_groups.npy'):
	gene_groups = np.load(filename).item()

	# Making the matrix coloured by genospecies
	sorted_strain_names = pd.read_csv('C:/Users/MariaIzabel/Desktop/MASTER/PHD/nchain/strains_id.txt', sep='\t')
...
#print creating_presence_absence_matrix()
### Venn diagrams 
